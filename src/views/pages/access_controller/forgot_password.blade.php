            ...
            <div class="circle circle-2"></div>
                ...
                <div class="star"><img src="{{ asset('aparajitha/assets/images/star.png') }}" alt=""><img src="{{ asset('aparajitha/assets/images/star.png') }}" alt="" class="small-star"></div>
                    <h2 class="titles mb-3 title-main">Reset Password</h2>
                     ...
                     <form action="{{route('forgot_password_action')}}" method="post">

                        @csrf
                         
                         <!-- <label class="label" for="email">Please enter your Email address</label> -->
                            <input id="email" autocomplete="off" type="email" placeholder="Please enter your email address" name="email" class="input email-input mt-3 mb-3 @error('password') is-invalid @enderror"  value="{{ old('email') }}"  required autocomplete="email" autofocus>
                       
                            
                            <button type="submit" class="my-btn login-btn">Get Password Reset link <span><i class="fa fa-chevron-right btn-icon"></i></span></button>
